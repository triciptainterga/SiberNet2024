...
<head runat="server">
    ...
    <link rel="icon" type="image/png" sizes="56x56" href="Sibernet.png" />
    <title>CRM SIBERNET</title>
                            ...
                            <div class="bg-white-10 rounded5" style="background-color: white;">
                                <div class="content-top-agile p-10 pb-0">
                                    ...
                                    <span class="light-logo">
                                        <img src="sibernet.png" alt="logo" width="120" /></span>
                                    ...
                                    <form id="form1" runat="server">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" runat="server" class="form-control pl-15 bg-dark text-black plc-white" id="Login_Username" placeholder="Username" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text  bg-dark text-white"><i class="ti-lock"></i></span>
                                                </div>
                                                <input type="password" runat="server" class="form-control pl-15 bg-dark text-black plc-white" id="Login_Password" placeholder="Password" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-6">
			                            ...
			                            <label for="basic_checkbox_1">Remember Me</label>
                                            ...
                                            <div class="col-12 text-center">
                                                <button type="submit" id="Login_ButtonSubmit" runat="server" class="btn btn-primary btn-rounded mt-10">SIGN IN</button>
                                            </div>
                                            <!-- /.col -->
                                        </div>
                                    </form>
