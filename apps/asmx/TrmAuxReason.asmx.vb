...
Public Class TrmAuxReason1
    ...
    Public Function MasterAuxReason(ByVal TrxID As String, ByVal TrxAuxReason As String, ByVal TrxAuxType As String, ByVal TrxAuxLimit As String, ByVal TrxAuxStatus As String,
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.Parameters.AddWithValue("TrxAuxType", TrxAuxType)
                sqlComm.Parameters.AddWithValue("TrxAuxLimit", TrxAuxLimit)
        ...
        Catch ex As Exception
            ...
            strExec = "exec UIDESK_TrmDataAux '" & TrxID & "','" & TrxAuxReasonXSS & "','" & TrxAuxType & "','" & TrxAuxLimit & "','" & TrxAuxStatus & "','" & TrxUserNameXSS & "','" & TrxAction & "'"
    ...
    Public Function TableMasterAuxReason(ByVal TrxUserName As String) As String
        ...
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                ...
                sqlComm.Parameters.AddWithValue("@TrxAuxType", "0")
                sqlComm.Parameters.AddWithValue("@TrxAuxLimit", "0")
