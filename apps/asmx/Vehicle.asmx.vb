...
Public Class Vehicle
    ...
    Public Function Vehicle(ByVal ID As String, ByVal CustomerID As String, ByVal Number As String, ByVal UserName As String, ByVal Action As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.CommandText = "V2_Vehicle_Number"
        ...
        Catch ex As Exception
            ...
            strExec = "exec V2_Vehicle_Number '" & ID & "','" & CustomerID & "','" & Number & "','" & UserName & "','" & Action & "'"
