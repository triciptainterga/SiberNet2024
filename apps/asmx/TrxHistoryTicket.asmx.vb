...
Public Class TrxHistoryTicket1
    ...
    Public Function UIDESK_TrxHistoryTicket(ByVal TrxStartDate As String, ByVal TrxEnddate As String, ByVal TrxUserName As String, ByVal TrxTicketNumber As String, ByVal TrxFilterType As String) As String
        ...
        Dim ExecSP = "" & NameSP & " '" & TrxStartDate & "','" & TrxEnddate & "','" & TrxUserName & "','" & TrxTicketNumber & "', '" & TrxFilterType & "'"
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                ...
                sqlComm.Parameters.AddWithValue("@TrxFilterType", TrxFilterType)
