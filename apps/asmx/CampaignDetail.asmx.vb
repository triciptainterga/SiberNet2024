...
Public Class CampaignDetail1
    ...
    Public Function ActionCampaign(ByVal ID As String, ByVal HeaderID As String, ByVal Name As String, ByVal Description As String,
                                  ByVal Status As String, ByVal TypeCall As String, ByVal LogicData As String, ByVal UserName As String, ByVal Action As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.Parameters.AddWithValue("TypeCall", TypeCall)
                sqlComm.Parameters.AddWithValue("LogicData", LogicData)
        ...
        Catch ex As Exception
            ...
            listTickets.Add(objectTickets)
            strExec = "exec Campaign_TambahHeader '" & ID & "','" & HeaderID & "','" & Name & "','" & Description & "','" & Status & "','" & TypeCall & "','" & LogicData & "','" & UserNameXSS & "','" & Action & "'"
