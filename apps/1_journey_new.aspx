...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="Hd_TicketPosition" runat="server" />
                        ...
                        <div class="col-lg-8 col-12">
                            <div class="box">
                                            ...
                                            <div>
                                                <ul class="list-inline mb-0 font-size-18">
                                                    ...
                                                    <li class="list-inline-item" id="newCall"><a href="#" class="hover-primary" onclick="click2Call()">
														...
														<li class="list-inline-item" id="newCall"><a href="#" class="hover-primary" onclick="PreviewContract()">
                                                        <img src="../Images/icon/contract.png" width="24"></a></li>
                                ...
                                <div class="box-footer">
                                    ...
                                    <div class="row" id="JiraForm" style="margin-top: 10px;">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Product</label>
                                ...
                                <div class="box-body px-0 pt-0" style="height: 1155px; overflow-y: scroll;">
                                    <div class="position-relative p-20">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="text-primary">Paket Broadband</label>
                                        ...
                                        <div class="row" id="JiraFormLabel">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="text-primary">Jira ID</label>
                                                    <p class="font-weight-normal" id="Ticket_JiraID"></p>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="text-primary">Jira Key</label>
                                                    <p class="font-weight-normal" id="Ticket_JiraKey"></p>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="text-primary">Jira Self</label>
                                                    <p class="font-weight-normal" id="Ticket_JiraSelf"></p>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="text-primary">Jira Product</label>
                                                    <p class="font-weight-normal" id="Ticket_Product"></p>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="text-primary">Jira Mobile Apps Version</label>
                                                    <p class="font-weight-normal" id="Ticket_Mobile"></p>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="text-primary">Jira Platform</label>
                                                    <p class="font-weight-normal" id="Ticket_Platform"></p>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="text-primary">Jira Browser</label>
                                                    <p class="font-weight-normal" id="Ticket_Browser"></p>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="text-primary">Jira Date</label>
                                                    <p class="font-weight-normal" id="Ticket_JiraDate"></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
