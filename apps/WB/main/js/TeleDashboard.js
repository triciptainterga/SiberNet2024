...
function summaryCall() {
    $.ajax({
		...
		//url: "https://cloud.uidesk.id/v2uidesk/apps/asmx/Tele_Dashboard.asmx/Tele_DashboardSummaryCall?UserName=Admin&XStartDate=2023-01-01&XEndDate=2023-03-25",
		//data: {},
        //data: JSON.stringify({ UserName: 'Admin', XStartDate: $('#start_date').val(), XEndDate: $('#end_date').val() }),
        data: JSON.stringify({ UserName: 'Admin', XStartDate: '2023-01-01', XEndDate: '2023-03-25' }),
