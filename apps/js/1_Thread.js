        ...
        success: function (data) {
            ...
            if (json.length == 0) {
                ...
                for (i = 0; i < json.length; i++) {
                    ...
                    //    var FollowThread = json[i].ValueThread
                    //}
                    if (json[i].ValueThread == "Email" || json[i].ValueThread == "E-MAIL") {
                        var TrxColor = "info";
                        var urlClick = "<div class='dropdown'>" +
                            ...
                            "</div>" +
                            "</div>"
                        var ThreadCategoryImg = "<img width='32px' src='../images/icon/email.png'>";
                    ...
                    if (json[i].ThreadCategory == "" || json[i].ThreadCategory == null) {
                        if (json[i].ValueThread == "Email" || json[i].ValueThread == "EMAIL") {
                            ...
                            var ThreadCategoryImg = "<img width='32px' src='../images/icon/messenger.png'>";
                        } else if (json[i].ValueThread == "Call" || json[i].ValueThread == "call") {
                            var ThreadCategoryImg = "<img width='32px' src='../images/icon/inbound.png'>";
                        } else {
                            var ThreadCategoryImg = "<center>-</center>";
                        }
                    } else if (json[i].ThreadCategory == "ig") {
                        var ThreadCategoryImg = "<img width='32px' src='../images/icon/instagram.png'>";
                    } else if (json[i].ThreadCategory == "fb") {
                        var ThreadCategoryImg = "<img width='32px' src='../images/icon/facebook.png'>";
                    } else if (json[i].ThreadCategory == "whatsapp") {
                        var ThreadCategoryImg = "<img width='32px' src='../images/icon/whatsapp.png'>";
                    } else if (json[i].ThreadCategory == "chat-widget") {
                        var ThreadCategoryImg = "<img width='32px' src='../images/icon/LiveChat.png'>";
                    }
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (x = 0; x < 1; x++) {
                ...
                for (i = 0; i < json.length; i++) {
                    if (json[i].ChannelData.toLowerCase() == "email") {
                        var TrxColor = "warning";
                        var imgChannel = "email.png";
                        var sizeImg = "36";
                    } else if (json[i].ChannelData.toLowerCase() == "call" ) {
                        var TrxColor = "primary";
                        var imgChannel = "inbound.png";
                        var sizeImg = "36";
                    } else if (json[i].ChannelData.toLowerCase() == "instagram") {
                        var TrxColor = "danger";
                        var imgChannel = "instagram.png";
                        var sizeImg = "36";
                    } else if (json[i].ChannelData.toLowerCase() == "facebook") {
                        var TrxColor = "primary";
                        var imgChannel = "facebook.png";
                        var sizeImg = "36";
                    } else if (json[i].ChannelData.toLowerCase() == "whatsapp" ) {
                        var TrxColor = "success";
                        var imgChannel = "whatsapp.png";
                        var sizeImg = "36";
                    } else if (json[i].ChannelData.toLowerCase() == "twitter") {
                        var TrxColor = "primary";
                        var imgChannel = "twitter.png";
                        var sizeImg = "36";
                    } else if (json[i].ChannelData.toLowerCase() == "outbound") {
                        var TrxColor = "primary";
                    ...
                    result += '<div class="col-12 col-lg-4"><a href="1_Thread.aspx?mid=1009&name='+ json[i].ChannelData +'">' +
                        ...
                        '<span>' +
                        '<img class="img-bordered-sm" src="../images/icon/' + imgChannel + '" alt="' + json[i].ChannelData +'" height="'+ sizeImg +'"><!--<i class="' + json[i].statusIcon + ' font-size-46"></i>-->' +
                        '<!--<br>' +
                        json[i].ChannelData +
                        '--></span>' +
