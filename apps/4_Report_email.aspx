                    ...
                    <div class="box-body p-15">
                        ...
                        <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="tempTrxEmail" runat="server" Width="100%"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="Body" FieldName="DescriptionNonHtml" Width="250px" PropertiesTextEdit-EncodeHtml="false"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataDateColumn Caption="Agent Date Received" FieldName="Email_Date" Width="150px" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd HH:MM:ss"></dx:GridViewDataDateColumn>
